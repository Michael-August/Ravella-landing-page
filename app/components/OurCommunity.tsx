...
const StatCard = ({
  ...
  <div className="flex flex-col items-center font-display bg-gray-500/10 rounded-xl p-4">
    <Icon className="w-8 h-8 mb-2 text-amber-700" strokeWidth={1.5} />
...
const FeatureCard = ({
  ...
  <div
    className={`${bgColor} rounded-2xl p-6 flex flex-col justify-start min-h-[140px]`}
  >
    <h3 className="mb-2 text-2xl font-bold text-[#FAF8F5]">{title}</h3>
    <p className="text-lg leading-relaxed font-semibold text-[#FAF8F5]">
      {description}
    </p>
  </div>
);
...
export default function OurCommunity() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-white px-6 py-12 lg:px-16 lg:py-16 mt-20 lg:mt-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            {/* Left Content */}
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-[#32241B] leading-tight mb-6">
      ...
      <section className="py-8 lg:py-12 border-t max-w-7xl mx-auto">
        {/* <div className=""> */}
      ...
      {/* Bottom Section */}
      <section className="relative bg-[#F5F5F7] rounded-[70px] px-6 py-12 lg:px-16 lg:py-16 mt-20 lg:mt-32">
        <img
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="max-w-lg text-xl text-muted-foreground mb-6">
            ...
            <div className="relative">
              <div className="relative overflow-hidden">
                <img src="/celebrating.png" alt="Team meeting" />
              </div>
            </div>
          </div>
        </div>
