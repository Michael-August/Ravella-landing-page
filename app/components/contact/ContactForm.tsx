      ...
      <div className="grid lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 md:gap-7 lg:gap-8 xl:gap-10 2xl:gap-12">
        ...
        <div className="space-y-4 xs:space-y-5 sm:space-y-6 md:space-y-7 lg:space-y-8">
          ...
          <div className="bg-[#F5F5F5] rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8">
            <div className="flex items-center gap-2 mb-2 xs:mb-3 sm:mb-4">
              ...
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-[#FF9801]">General Communication</h3>
            </div>
            ...
            <div className="inline-block bg-white border border-gray-300 rounded-md xs:rounded-lg sm:rounded-xl px-3 xs:px-4 sm:px-5 md:px-6 py-2 xs:py-2.5 sm:py-3">
              <a href="mailto:hello@ravellaultrasolution.com" className="text-[#653424] font-medium text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl break-all">
          ...
          <div className="bg-[#F5F5F5] rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8">
            <div className="flex items-center gap-2 mb-2 xs:mb-3 sm:mb-4">
              ...
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-[#FF9801]">Help & support</h3>
            </div>
            ...
            <div className="inline-block bg-white border border-gray-300 rounded-md xs:rounded-lg sm:rounded-xl px-3 xs:px-4 sm:px-5 md:px-6 py-2 xs:py-2.5 sm:py-3">
              <a href="mailto:support@ravellaultrasolution.com" className="text-[#653424] font-medium text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl break-all">
        ...
        <div className="bg-[#F5F5F5] rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8">
          <div className="space-y-3 xs:space-y-4 sm:space-y-5 md:space-y-6">
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-[#525252] text-xs xs:text-sm sm:text-base mb-1 xs:mb-2">
                Full name*
              </label>
              <input
                type="text"
            ...
            {/* Username */}
            <div>
              <label htmlFor="username" className="block text-[#525252] text-xs xs:text-sm sm:text-base mb-1 xs:mb-2">
                Username*
              </label>
              <input
                type="text"
            ...
            {/* Phone Number */}
            <div>
              <label htmlFor="phone" className="block text-[#525252] text-xs xs:text-sm sm:text-base mb-1 xs:mb-2">
                Phone number*
              </label>
              <input
                type="tel"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-[#525252] text-xs xs:text-sm sm:text-base mb-1 xs:mb-2">
                Email*
              </label>
              <input
                type="email"
            ...
            {/* Message */}
            <div>
              <label htmlFor="message" className="block text-[#525252] text-xs xs:text-sm sm:text-base mb-1 xs:mb-2">
                How can we help?
              </label>
              <textarea
                id="message"
