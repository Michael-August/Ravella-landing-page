	...
	return (
		<section className="py-8 sm:py-10 lg:py-16 px-4 sm:px-6 lg:px-12 bg-[#F5F5F7] rounded-[40px] sm:rounded-[50px] lg:rounded-[70px] mt-6 sm:mt-8 lg:mt-12">
			<div className="">
              ...
              "
						>
							At Ravella Ultra Solution Limited, we don't just
							offer products—we deliver life-changing solutions
							designed to restore health, boost vitality, and
							transform lives. Our NAFDAC-approved, scientifically
							formulated herbal products combine the best of
							nature and science to promote total well-being.
						</p>
