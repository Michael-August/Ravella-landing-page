...
const FOOTER_LINKS = {
	quickLinks: [
		...
		{ label: "Our Compensation Plan", href: "/compensation-plan" },
	],
	legal: [
...
const SOCIAL_LINKS = [
	...
	{ Icon: Linkedin, label: "LinkedIn", href: "#" },
	{
		Icon: Youtube,
		label: "YouTube",
		href: "https://www.youtube.com/@RavellaUltraSolution/",
	},
];
			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 mb-8 sm:mb-10 lg:mb-12">
					...
					<div className="sm:col-span-2 lg:col-span-1">
						...
						<p className="text-[#FAF8F5CC] text-sm sm:text-base lg:text-[17px] leading-relaxed mb-4 sm:mb-6 tracking-wide max-w-sm">
							Ravella is Beyond Experience... It Is The Future of
							Network Marketing
						</p>
					...
					{/* Quick Links */}
					<div>
						<h3 className="text-base sm:text-lg lg:text-xl font-bold mb-3 sm:mb-4 text-[#FAF8F5] tracking-wider">
							Quick Links
						</h3>
					...
					<div>
						...
						<div className="space-y-3 sm:space-y-4">
							<div>
								<p className="text-[#FAF8F5CC] text-sm sm:text-base lg:text-lg tracking-wide font-normal mb-1">
									Service Hours:
								</p>
								<p className="text-[#FAF8F5CC] text-sm sm:text-base lg:text-lg tracking-wide font-normal">
									Mon - Fri, 8AM to 5PM
								</p>
							</div>
				...
				<div className="border-t border-[#FAF8F51A] pt-6 sm:pt-8 mb-6 sm:mb-8">
					<div className="flex items-start gap-2 sm:gap-3 text-[#FAF8F5CC] text-sm sm:text-base lg:text-lg tracking-wide font-normal">
						...
						<p className="leading-relaxed">
							No 21 Church Street, ITS Plaza off Ikwelle Street,
							Igbosan Road, Opebi, Ikeja, Lagos, Nigeria.
						</p>
					</div>
				</div>
				...
				<div className="border-t border-[#FAF8F51A] pt-4 sm:pt-6">
					<p className="text-[#FAF8F5CC] text-xs sm:text-sm lg:text-base tracking-wide font-normal text-center sm:text-left">
						© {currentYear} Ravella Ultra Solution Ltd. All Rights
						Reserved.
					</p>
				</div>
				...
				<img
					src="/Ravella.png"
					alt="Ravella logo"
					className="mx-auto mt-4 sm:mt-6 h-16 sm:h-32 lg:h-auto w-auto"
				/>
			</div>
		</footer>
	);
